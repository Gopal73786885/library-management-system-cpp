...
private:
    ...
    void showGuideLineMessage()
    {
        ...
        cout << "Hello Friends,\nWe welcome to you here our guide lines.\n";
        cout << "i. Please select only correct option from the menu."<<endl;
        cout << "ii. If you press wrong option three times then the software goes down."<<endl;
        cout <<endl<< "1. Show this message again."<<endl;
        cout << "2. Never show this message again."<<endl;
        cout << ">>> ";
        char g1;
        cin >> g1;
        switch(g1)
...
void Security::Login()
{
    ...
    if(OpenSecurityFile.is_open())
    {
        ...
        else
        {
            ...
            {
                system("cls");
                cout << "Oops, Server is going to die.";
                Sleep(2000);
                exit(0);
            }
            goto _checkUser;
...
//            goto pass;
        ...
        Sleep(1000);
        system("cls");
        cout << "This is your first Login \nSo you need to change default username and password for better Security Mechanism."<<endl;
...
int main()
{
    ...
    cout << "2. Library."<<endl;
    cout << "3. Books Issue."<<endl;
    cout << "4. Settings."<<endl;
    cout << "5. Helps."<<endl;
    cout << "6. About ?"<<endl;
    cout << "7. Exits."<<endl;
    cout << "8. Restart The Machine."<<endl;
    cout << ">>> ";
    input = getch();
    switch(input)
    {
            ...
            case '2': //    Students Lists
                {
                    ...
                    if(FILE003.is_open())
                    {
                        ...
                        cout <<setw(5)<<"id"<<setw(25)<<"Name"<<setw(15)<<"Faculty"<<setw(20)<<"Address"<<setw(15)<<"Gender"<<setw(25)<<"Email"<<setw(20)<<"Contact"<<endl;
